...
- The sandboxed external tool execution backend, memory compaction, full timeline replay UI, signed installer pipeline, updater, and cross-platform desktop validation remain follow-up work.
