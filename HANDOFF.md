...
- Windows follow-up runs [29311397456](https://github.com/MattSureham/quorum/actions/runs/29311397456) and [29311586815](https://github.com/MattSureham/quorum/actions/runs/29311586815) timed out in mixed Git/fs.watch integration tests. Run [29311768250](https://github.com/MattSureham/quorum/actions/runs/29311768250) then isolated the remaining failure to a missing Git author identity while initializing a new repository. `GitWorkspace` now supplies repo-local Quorum defaults only when a new repository lacks identity; it never changes global Git config. A fresh run is required.
